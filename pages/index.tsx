...
import { loggout } from "../store/slices/authSlice";
...
export default function Home() {
  ...
  const [valorAnticipoArrendamiento, setValorAnticipoArrendamiento] = useState({
    value: "",
    touched: false,
  });
  ...
  const cotiza = () => {
    ...
    let valorResidualSinIva =
      vFSInIVA * (parseFloat(valorResidual.value) / 100);
    ...
    let valorInicialArrendamiento = parseFloat(
      valorAnticipoArrendamiento.value
    );
    ...
    let montoArrendamiento =
      parseFloat(valorFactura.value) +
      parseFloat(valorAccesorios.value) +
      otrosGastos * 1.16 -
      valorInicialArrendamiento;

    console.log("Monto Arrendamiento: ", montoArrendamiento);
    let comisionAp =
      (montoArrendamiento * parseFloat(valorComisionApertura.value)) / 100;
    ...
    let rentaMensual = PMT(
      0.0258,
      parseInt(plazo.value),
      -montoArrendamientoFinalSinIva.toFixed(2),
      0,
      0
    );
    console.log(
    ...
    setCotizacion((currentValue) => ({
      ...currentValue,
      montoArrendamiento: montoArrendamientoFinalSinIva,
      comisionApSinIva,
      valorResidual: valorResidualSinIva,
      rentaMensual,
    }));
  };
  ...
  return (
    <>
      ...
      {authorization && authorization === "Cliente" ? (
        <Typography>Pantallas del cliente</Typography>
      ) : (
        <AdministratorsMainOptions />
      )}
    </>
  );
  ...
  return (
    <Container sx={{ mt: 5 }}>
        ...
        <Grid container spacing={3}>
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              helperText={
                valorFactura.touched && valorFactura.value == ""
                  ? "El valor de la factura es requerido"
                  : ""
              }
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              onChange={(e) =>
                setValorAccesorios((currentValue) => ({
                  ...currentValue,
                  value: e.target.value,
                }))
              }
              ...
              helperText={
                valorAccesorios.touched && valorAccesorios.value == ""
                  ? "El valor de accesorios es requerido"
                  : ""
              }
          ...
          <Grid item xs={12}>
            <TextField
              onChange={(e) =>
                setValorAnticipoArrendamiento((currentValue) => ({
                  ...currentValue,
                  value: e.target.value,
                }))
              }
              ...
              color={
                valorAnticipoArrendamiento.value == "" ? "warning" : "info"
              }
              helperText={
                valorAnticipoArrendamiento.touched &&
                valorAnticipoArrendamiento.value == ""
                  ? "El valor del anticipo es requerido"
                  : ""
              }
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              helperText={
                valorRentas.touched && valorRentas.value == ""
                  ? "El valor de las rentas es requerido"
                  : ""
              }
              // color={errors.rentasDeposito? 'warning' : 'info'}
              // helperText={errors.rentasDeposito? 'El valor de la factura es requerido' : ''}
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              onChange={(e) =>
                setValorFondoReserva((currentValue) => ({
                  ...currentValue,
                  value: e.target.value,
                }))
              }
              ...
              helperText={
                valorFondoReserva.touched && valorFondoReserva.value == ""
                  ? "El valor de fondo de reserva es requerido"
                  : ""
              }
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              onChange={(e) =>
                setValorComisionApertura((currentValue) => ({
                  ...currentValue,
                  value: e.target.value,
                }))
              }
              ...
              helperText={
                valorComisionApertura.touched &&
                valorComisionApertura.value == ""
                  ? "El valor de la comisión por apertura es requerido"
                  : ""
              }
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              onChange={(e) =>
                setValorSeguroAnualC((currentValue) => ({
                  ...currentValue,
                  value: e.target.value,
                }))
              }
              ...
              helperText={
                valorSeguroAnualC.touched && valorSeguroAnualC.value == ""
                  ? "El valor del seguro anual es requerido"
                  : ""
              }
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              onChange={(e) =>
                setValorOtrosGastos((currentValue) => ({
                  ...currentValue,
                  value: e.target.value,
                }))
              }
              ...
              helperText={
                valorOtrosGastos.touched && valorOtrosGastos.value == ""
                  ? "El valor de otros gastos es requerido"
                  : ""
              }
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              onChange={(e) =>
                setValorFondoReservaMensual((currentValue) => ({
                  ...currentValue,
                  value: e.target.value,
                }))
              }
              ...
              helperText={
                valorFondoReservaMensual.touched &&
                valorFondoReservaMensual.value == ""
                  ? "El valor del fondo de reserva es requerido"
                  : ""
              }
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              helperText={
                valorResidual.touched && valorResidual.value == ""
                  ? "El valor residual es requerido"
                  : ""
              }
          ...
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              variant="outlined"
              onBlur={() =>
                setPlazo((currentValue) => ({ ...currentValue, touched: true }))
              }
              color={plazo.value == "" ? "warning" : "info"}
              helperText={
                plazo.touched && plazo.value == ""
      ...
      {cotizacion.comisionApSinIva == 0 ||
      (isNaN(cotizacion.comisionApSinIva) &&
        cotizacion.montoArrendamiento == 0) ||
      (isNaN(cotizacion.montoArrendamiento) && cotizacion.valorResidual == 0) ||
      (isNaN(cotizacion.valorResidual) && cotizacion.rentaMensual == 0) ||
      isNaN(cotizacion.rentaMensual) ? (
        ""
      ) : (
        <Container>
          <Typography>
            La comision por apertura es: {cotizacion.comisionApSinIva}
          </Typography>
          <Typography>
            El monto del arrendamiento es: {cotizacion.montoArrendamiento}
          </Typography>
          <Typography>
            El valor residual del arrendamiento es: {cotizacion.valorResidual}
          </Typography>
          <Typography>
            El valor de la renta mensual del arrendamiento es:{" "}
            {cotizacion.rentaMensual}
          </Typography>
        </Container>
      )}
